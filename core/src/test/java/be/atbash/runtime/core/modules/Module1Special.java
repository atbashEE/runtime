...
public class Module1Special extends AbstractTestModule {
    @Override
    public String name() {
        return "module1Special";
    }
    ...
    @Override
    public void run() {
        ModulesLogger.addEvent("Start Module 1 Special");
        try {
            Thread.sleep(1000);
        ...
        ModulesLogger.addEvent("End Module 1 Special");
    }
}
