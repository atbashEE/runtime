...
public class SetLoggingConfigurationRemoteCommand extends SetLoggingConfigurationCommand implements ServerRemoteCommand {
    ...
    public CommandResponse handleCommand(Map<String, String> options) {
        ...
        List<String> errors = configurationManager.setLoggingConfigCommand(options.get("").split(","));
