...
public class RuntimeApplicationEventListener implements ApplicationEventListener {
    ...
    public void onEvent(ApplicationEvent event) {
        if (event.getType() == ApplicationEvent.Type.INITIALIZATION_APP_FINISHED) {
            AbstractDeployment currentDeployment = CurrentDeployment.getInstance().getCurrent();
            currentDeployment.setApplicationReady();

            applicationPath = currentDeployment.getDeploymentData(JerseySEModuleConstant.APPLICATION_PATH);
