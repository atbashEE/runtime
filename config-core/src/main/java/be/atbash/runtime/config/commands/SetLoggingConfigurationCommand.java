...
public class SetLoggingConfigurationCommand extends AbstractConfigurationCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(SetLoggingConfigurationCommand.class);
    ...
    public Integer call() throws Exception {
        ...
        List<String> result = configurationManager.setLoggingConfigCommand(options);
