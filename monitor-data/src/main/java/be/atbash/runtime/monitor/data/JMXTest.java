...
public class JMXTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        serverMon.setVersion("Test 1.2.3");
        // Register MBean
        MBeanServer server = ManagementFactory.getPlatformMBeanServer();
        ObjectName objectName = new ObjectName("com.itsallbinary.jmx:name=applicationInfo");
        server.registerMBean(serverMon, objectName);
